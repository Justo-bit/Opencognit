...
CREATE TABLE IF NOT EXISTS work_progress_records (
    ...
    planned_pct REAL DEFAULT 0, actual_pct REAL NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS site_diary_entries (
    ...
    weather_am TEXT, weather_pm TEXT, temperature_min REAL, temperature_max REAL,
    ...
    reviewed_by TEXT, erstellt_am TEXT NOT NULL DEFAULT (datetime('now'))
);
