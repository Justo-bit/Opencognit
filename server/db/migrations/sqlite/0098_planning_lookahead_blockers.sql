...
CREATE TABLE IF NOT EXISTS lookahead_plans (
    ...
    lookahead_weeks INTEGER NOT NULL, generated_am TEXT NOT NULL DEFAULT (datetime('now')),
...
CREATE TABLE IF NOT EXISTS lookahead_readiness (
    id TEXT PRIMARY KEY NOT NULL, lookahead_id TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS schedule_blockers (
    ...
    raised_by TEXT NOT NULL, raised_am TEXT NOT NULL DEFAULT (datetime('now')),
...
CREATE TABLE IF NOT EXISTS planning_reviews (
    ...
    comments TEXT, reviewed_am TEXT NOT NULL DEFAULT (datetime('now')),
    erstellt_am TEXT NOT NULL DEFAULT (datetime('now'))
);
