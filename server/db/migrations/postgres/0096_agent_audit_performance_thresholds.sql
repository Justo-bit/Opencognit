...
CREATE TABLE IF NOT EXISTS ai_agent_audit_events (
    ...
    occurred_am TEXT NOT NULL DEFAULT (NOW()),
...
CREATE TABLE IF NOT EXISTS ai_agent_performance_metrics (
    ...
    avg_review_time_hours DOUBLE PRECISION, financial_impact DOUBLE PRECISION,
    schedule_impact_days DOUBLE PRECISION, safety_impact_count INTEGER DEFAULT 0,
    acceptance_rate DOUBLE PRECISION, computed_am TEXT NOT NULL DEFAULT (NOW()),
    erstellt_am TEXT NOT NULL DEFAULT (NOW())
);
...
CREATE TABLE IF NOT EXISTS ai_agent_review_thresholds (
    ...
    threshold_type TEXT NOT NULL, threshold_value DOUBLE PRECISION NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS ai_agent_review_queues (
    ...
    reviewed_am TEXT, erstellt_am TEXT NOT NULL DEFAULT (NOW())
);
