...
CREATE TABLE IF NOT EXISTS ai_agent_versions (
    id SERIAL PRIMARY KEY, agent_id TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS ai_agent_recommendations (
    ...
    evidence_summary TEXT, confidence DOUBLE PRECISION,
    risk_level TEXT NOT NULL DEFAULT 'medium',
    requires_human_approval INTEGER NOT NULL DEFAULT 1,
    created_am TEXT NOT NULL DEFAULT (NOW()),
    erstellt_am TEXT NOT NULL DEFAULT (NOW())
);
...
CREATE TABLE IF NOT EXISTS ai_agent_evidence_links (
    id SERIAL PRIMARY KEY, recommendation_id TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS ai_agent_reviews (
    ...
    decision_reason TEXT, reviewed_am TEXT NOT NULL DEFAULT (NOW()),
    erstellt_am TEXT NOT NULL DEFAULT (NOW())
);
