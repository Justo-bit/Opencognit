...
// ===== PR-IPC-1: BOQ-vs-Actual + IPC Backbone =====
export const ipcCertificates = sqliteTable('ipc_certificates', {
  id: text('id').primaryKey(),
  companyId: text('unternehmen_id').notNull(),
  projectId: text('project_id').notNull(),
  contractId: text('contract_id').notNull(),
  ipcNumber: text('ipc_number'),
  periodStart: text('period_start').notNull(),
  periodEnd: text('period_end').notNull(),
  valuationDate: text('valuation_date').notNull(),
  workDoneThisPeriod: real('work_done_this_period').notNull().default(0),
  cumulativeWorkDone: real('cumulative_work_done').notNull().default(0),
  retentionThisPeriod: real('retention_this_period').default(0),
  cumulativeRetention: real('cumulative_retention').default(0),
  advanceRecovery: real('advance_recovery').default(0),
  variationAmount: real('variation_amount').default(0),
  claimAmount: real('claim_amount').default(0),
  certifiedAmount: real('certified_amount').default(0),
  previouslyCertified: real('previously_certified').default(0),
...
export const ipcItems = sqliteTable('ipc_items', {
  id: text('id').primaryKey(),
  ipcId: text('ipc_id').notNull(),
  boqItemId: text('boq_item_id').notNull(),
  itemDescription: text('item_description').notNull(),
  boqQuantity: real('boq_quantity').notNull().default(0),
  previousQuantity: real('previous_quantity').notNull().default(0),
  thisPeriodQuantity: real('this_period_quantity').notNull().default(0),
  cumulativeQuantity: real('cumulative_quantity').notNull().default(0),
  ...
  thisPeriodAmount: real('this_period_amount').notNull().default(0),
  cumulativeAmount: real('cumulative_amount').notNull().default(0),
  measurementBasis: text('measurement_basis'),
  notes: text('notes'),
  createdAt: text('erstellt_am').notNull(),
});

export const measurementSheets = sqliteTable('measurement_sheets', {
  id: text('id').primaryKey(),
  ipcItemId: text('ipc_item_id').notNull(),
  description: text('description').notNull(),
  measurementType: text('measurement_type').notNull().default('field_measure'),
  ...
  measuredAt: text('measured_am').notNull(),
  checkedBy: text('checked_by'),
  checkedAt: text('checked_am'),
  sketchRef: text('sketch_ref'),
  photoRef: text('photo_ref'),
  createdAt: text('erstellt_am').notNull(),
});

export const boqVsActualRecords = sqliteTable('boq_vs_actual_records', {
  id: text('id').primaryKey(),
  companyId: text('unternehmen_id').notNull(),
  projectId: text('project_id').notNull(),
  boqItemId: text('boq_item_id').notNull(),
  budgetQuantity: real('budget_quantity').notNull().default(0),
  ...
  amountVariance: real('amount_variance').notNull().default(0),
...
export const ipcAgentRecommendations = sqliteTable('ipc_agent_recommendations', {
  id: text('id').primaryKey(),
  companyId: text('unternehmen_id').notNull(),
