...
// ===== PR-QC-1: Inspection + Test Plan Backbone =====
export const inspectionTestPlans = sqliteTable('inspection_test_plans', {
  id: text('id').primaryKey(),
  companyId: text('unternehmen_id').notNull(),
  projectId: text('project_id').notNull(),
  activityId: text('activity_id'),
  boqItemId: text('boq_item_id'),
  itpNumber: text('itp_number'),
  title: text('title').notNull(),
  description: text('description'),
  discipline: text('discipline').notNull().default('civil'),
  specificationRef: text('specification_ref'),
...
export const itpCheckpoints = sqliteTable('itp_checkpoints', {
  id: text('id').primaryKey(),
  itpId: text('itp_id').notNull(),
  sequenceNumber: integer('sequence_number').notNull(),
  checkpointType: text('checkpoint_type').notNull().default('hold_point'),
  description: text('description').notNull(),
  acceptanceCriteria: text('acceptance_criteria'),
  testMethod: text('test_method'),
  frequency: text('frequency'),
  responsibleParty: text('responsible_party'),
  witnessRequired: integer('witness_required').notNull().default(0),
  witnessRole: text('witness_role'),
  status: text('status').notNull().default('pending'),
  inspectedBy: text('inspected_by'),
  inspectedAt: text('inspected_am'),
  result: text('result'),
  comments: text('comments'),
  createdAt: text('erstellt_am').notNull(),
});

export const materialInspections = sqliteTable('material_inspections', {
  id: text('id').primaryKey(),
  companyId: text('unternehmen_id').notNull(),
  projectId: text('project_id').notNull(),
  grnId: text('grn_id'),
  ...
  quantityInspected: real('quantity_inspected').notNull(),
  quantityPassed: real('quantity_passed').notNull().default(0),
  quantityRejected: real('quantity_rejected').notNull().default(0),
  inspectionType: text('inspection_type').notNull().default('visual'),
  testResults: text('test_results'),
  standardRef: text('standard_ref'),
  inspectedBy: text('inspected_by').notNull(),
  inspectedAt: text('inspected_am').notNull(),
...
export const workInspections = sqliteTable('work_inspections', {
  id: text('id').primaryKey(),
  companyId: text('unternehmen_id').notNull(),
  projectId: text('project_id').notNull(),
  activityId: text('activity_id'),
  ...
  inspectionType: text('inspection_type').notNull().default('in_process'),
  description: text('description').notNull(),
  ...
  reworkRequired: integer('rework_required').notNull().default(0),
  witnessPresent: text('witness_present'),
  notes: text('notes'),
  createdAt: text('erstellt_am').notNull(),
});

export const qcAgentRecommendations = sqliteTable('qc_agent_recommendations', {
  id: text('id').primaryKey(),
  companyId: text('unternehmen_id').notNull(),
