        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center', flexWrap: 'wrap' }}>
            <select value={status} onChange={e => setStatus(e.target.value as any)} style={{
              ...
              {STATUS_OPTIONS.map(s => <option key={s} value={s}>{STATUS_CFG[s].label[t('autoGenerated.en')]}</option>)}
            </select>
    ...
    <div style={{
      ...
      <div style={{ display: 'flex', gap: '0.5rem', marginBottom: '1rem', flexWrap: 'wrap' }}>
        <select value={ebene} onChange={e => setEbene(e.target.value as any)} style={{
          ...
          {EBENE_OPTIONS.map(e => <option key={e} value={e}>{EBENE_CFG[e].label[t('autoGenerated.en')]}</option>)}
        </select>
        <select value={status} onChange={e => setStatus(e.target.value as any)} style={{
          padding: '0.375rem 0.625rem', borderRadius: 0, fontSize: '0.8125rem',
          background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.1)',
          ...
          <option value="planned">{STATUS_CFG.planned.label[t('autoGenerated.en')]}</option>
          <option value="active">{STATUS_CFG.active.label[t('autoGenerated.en')]}</option>
        </select>
      </div>
...
export function Goals() {
  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: '2rem', flexWrap: 'wrap', gap: '1rem' }}>
        <div>
          ...
          <p style={{ fontSize: '0.875rem', color: '#71717a', marginTop: '0.25rem' }}>
            {t('autoGenerated.trackYourCompany')s strategic goals and milestones"}
          </p>
        </div>
      ...
      <PageHelp id="goals" lang={t('autoGenerated.en')} />
      ...
      <div style={{ display: 'flex', gap: '0.5rem', marginBottom: '1.5rem', flexWrap: 'wrap' }}>
        {(['all', ...STATUS_OPTIONS] as const).map(s => {
          ...
          const cfg = s === 'all'
            ...
            : { color: STATUS_CFG[s].color, label: STATUS_CFG[s].label[t('autoGenerated.en')] };
          return (
