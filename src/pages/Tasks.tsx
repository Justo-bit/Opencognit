                              ...
                              <div style={{ display: 'flex', alignItems: 'center', gap: '0.375rem' }}>
                                ...
                                <button
                                  ...
                                  style={{
                                    ...
                                    borderRadius: 0,
                                    border: `1px solid ${a.isMaximizerMot('autoGenerated.rgba255255255008')}`,
                                    background: a.isMaximizerMot('autoGenerated.transparent'),
                                    cursor: 'pointer',
                                    display: 'flex', alignItems: 'center',
                                    color: a.isMaximizerMot('autoGenerated.52525b'),
                                    transition: 'all 0.2s',
                                    ...(a.isMaximizerMode ? { boxShadow: '0 0 8px rgba(239, 68, 68, 0.3)' } : {}),
                                  }}
                                >
                                  <Zap size={12} fill={a.isMaximizerMot('autoGenerated.none')} />
                                </button>
                              </div>
                              {expert && (
                                <div style={{
